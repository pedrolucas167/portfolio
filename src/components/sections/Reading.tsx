...
const books: Book[] = [
  ...
  },
  {
    ...
    cover: 'https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1566488498i/51198848.jpg',
    status: 'reading',
    progress: 40,
    category: 'Java',
  },
  {
    ...
    cover: 'https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1630589523i/57573212.jpg',
    status: 'next',
